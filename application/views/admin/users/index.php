                        ...
                        <div class="col-md-12">
                             <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><a href="<?php echo site_url('admin/users/create'); ?>" class="btn btn-block btn-primary"><i class="fa fa-plus"></i> <?php echo lang('users_create_user'); ?></a></h3>
                                </div>
                                <div class="box-body">
...
<?php foreach ($user->groups as $group):?>
                                                    <?php echo anchor('admin/groups/edit/'.$group->id, '<span class="label label-primary">'.htmlspecialchars($group->name, ENT_QUOTES, 'UTF-8').'</span>'); ?>
<?php endforeach?>
                                                </td>
