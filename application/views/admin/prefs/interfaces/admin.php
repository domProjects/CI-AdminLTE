                        ...
                        <div class="col-md-12">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="<?php echo site_url('admin/prefs/interfaces/admin'); ?>"><?php echo lang('menu_int_admin'); ?></a></li>
                                    <li><a href="<?php echo site_url('admin/prefs/interfaces/public'); ?>"><?php echo lang('menu_int_public'); ?></a></li>
                                </ul>
                                <div class="tab-content">
                                    ...
                                    <form method="post" action="<?php echo current_url(); ?>" class="form-horizontal" id="form-edit_admin" accept-charset="utf-8">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <div class="btn-group">
                                                        ...
                                                        <?php echo anchor('admin/prefs/reset_interfaces_admin', lang('actions_default_values'), array('class' => 'btn btn-danger')); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
